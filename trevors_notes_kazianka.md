...
Section 2 Copulas
	...
	Variables are independent if the copulas is the product copula
...
Section 4 Parameter Estimation
	...
	Additionally geometric anisotropy can be handled with additional coordinate transformation parameters

	Estimate the parameters jointly with maximum likelihood, however evaluation of the density is infeasible in higher dimensions. Instead use a composite likelihood approach.

	Test the GOF with either Kolmogorov Smirnoff or Cramer-von Miss
